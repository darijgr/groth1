...
in terms of $\lm$) which preserves the ceq statistic and switches the number of columns containing a $1$ with the number of columns containing a $2$ (i.e. acts as a transposition of $1$ and $2$ on the ircont statistic).
\end{lemma}
