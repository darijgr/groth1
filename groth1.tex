...
We would like to answer the following question: for which partitions $\cutvar=(i_1\geq \dots\geq i_s>0)$ there exists an rpp $T$ of shape $\lm$ such that $\cut(T)=\cutvar$?
