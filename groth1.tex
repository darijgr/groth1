...
\begin{todo}
 Tell the reader that trailing zeroes can be omitted when writing a
 partition.
\end{todo}
...
\begin{todo}
 Define bounded-degree or refer to some place (e.g., GriRei15)? Make ground ring explicit (even if it is $\Z$.)
 Define finite permutations.
\end{todo}
