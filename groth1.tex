...
\caption{The three descent-resolution steps \label{fig:des-res}}
\end{figure}
...
If we set $k=1$ then we have (2M), if we set $k=2$ then we have (M1), and if we set $k=4$ then we have (21). Resolving each of the conflicts results in the following 12-tables:
