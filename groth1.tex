...
finitely many elements.} of $x_1,x_2,\dots$.
...
\textit{irredundant content} (or, by way of abbreviation, the
\textit{$\operatorname{ircont}$ statistic})
...
by way of abbreviation, the
\textit{$\operatorname{ceq}$ statistic})
