...
\nolimits_{v}B$. Resolving this descent
...
$C\overset{\ast}{\Rrightarrow}D$. By induction,
$\operatorname*{Norm}\left(  D\right)  $ is a one-element set. Its unique element
clearly lies in both $\operatorname*{Norm}\left(  B\right)  $ and $\operatorname*{Norm}\left(  C\right)  $, so
